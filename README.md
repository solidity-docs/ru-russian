...
Вы можете поговорить с нами в чатах Gitter и Matrix, твитнуть нас в Twitter или создать новый топик на Solidity форуме. Мы рады любым вопросам, обратной связи и предложениям! 
...
Чтобы с чего-то начать и получить хороший обзор, пожалуйста, обратитесь к нашему официальному сайту [Solidity Language Portal](https://soliditylang.org).
...
Инструкции о том, как собрать и установить компилятор Солидити можно найти в [документации Solidity](https://docs.soliditylang.org/en/latest/installing-solidity.html#building-from-source).
...
Пожалуйста изучите [Гид разработчика](https://docs.soliditylang.org/en/latest/contributing.html),
если вы хотите помочь.

Вы можете найти наш текущие приоритеты по ошибкам и функциям для предстоящих релизов в [разделе проектов](https://github.com/ethereum/solidity/projects).
